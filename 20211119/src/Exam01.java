...
//        System.out.println(arry[2]);
        ...
        if (arry[2].equals("+")) {
            ...
            Calcu sub = new Sub();
            sub.setValue(Integer.parseInt(arry[0]), Integer.parseInt(arry[1]));
            sub.calculate();
        } else if (arry[2].equals("*")) {
            Calcu mul = new Mul();
            mul.setValue(Integer.parseInt(arry[0]), Integer.parseInt(arry[1]));
            mul.calculate();
        } else if (arry[2].equals("/")) {
            Calcu div = new Div();
            div.setValue(Integer.parseInt(arry[0]), Integer.parseInt(arry[1]));
            div.calculate();
        }
